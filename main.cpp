									 ...
									 const string &domainname)
{
	...
	if (f.openwrite (filename, 0644))
	{
		...
		// Write an idiot-repellant
		f.writeln ("; This file was automatically generated by Openpanel ");
		f.writeln ("; Do not modify this file; your changes likely will be overwritten");
